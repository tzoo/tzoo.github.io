---
layout: post
title:  "The Art of knowing what you don't Know"
date:   2025-07-06 16:00:00 +0530
categories: post
---
...
<!-- One major issue with using any GenAI model or application is that you need to know what you want to know. This is a strange paradox because if you know what you dont know then wjat you really need is a knowledge source. This can be an AI embedded knowledge source or any wiki or a search engine or even a person you  trust enough to ask for that information. Problem happens when you dont know what you want to know. Thats where you need someone who can ask you questions to understand what you need to know. In such cases a vanila LLM interaction is not sufficient. Thats where AI agents shine truly. Especially in the enterprise and restricted data environment where the answer to same question is generally differs as per asker's role, location, department, authorizations and object in question.
While LLMs know what "they" know, they dont know what "you" know or "need" to know. and thats why they shall clarify with user to diffrentiate between what user asked and what they really "need" to know. Thats when an AI response will be truly helpful. Agentic AI systems are first step in this direction and once they move beyond self-reasoning to counter-reasoning, we will see visible patterns of super intelligence. -->